...
const profiles = [
  { code: "administration", label: "Administration", description: "Pilotage complet de lՎtablissement.", permissions: ["students:view", "students:create", "students:edit", "enrollments:view", "enrollments:create", "grades:view", "grades:validate", "attendance:view", "results:view", "results:export", "finance:view", "payments:view", "users:view", "users:edit", "settings:view", "settings:edit", "archives:view", "audit:view"] },
